package com.rifqipadisiliwangi.challengchapterenam.view.adapters
...
import com.rifqipadisiliwangi.challengchapterenam.databinding.ItemFavoritesBinding
...
class FavoriteAdapter (var listMovie : List<FavoritesResponseItem>): RecyclerView.Adapter<FavoriteAdapter.ViewHoldler>() {
    ...
    override fun onBindViewHolder(holder: ViewHoldler, position: Int) {
        ...
        holder.binding.cardMovie.setOnClickListener{
            ...
            Navigation.findNavController(holder.itemView).navigate(R.id.action_favoriteFragment_to_detailFragment,arg)
        }
