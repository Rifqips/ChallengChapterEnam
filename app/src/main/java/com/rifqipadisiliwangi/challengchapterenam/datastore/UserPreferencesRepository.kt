package com.rifqipadisiliwangi.challengchapterenam.datastore

import android.content.Context
import android.util.Log
import androidx.datastore.core.DataStore
import androidx.datastore.dataStore
import com.rifqipadisiliwangi.protodatastore.UserProto
...
class UserPreferencesRepository (private val context: Context){
    ...
    suspend fun saveData(email : String, username : String, password : String, session : String) {
